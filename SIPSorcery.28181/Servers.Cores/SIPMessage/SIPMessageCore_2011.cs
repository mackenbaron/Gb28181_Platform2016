...
namespace SIPSorcery.GB28181.Servers.SIPMessage
{
    ...
    /// sip消息核心处理(版本2011)
    /// </summary>
    public class SIPMessageCore_2011 : MessageBase
    {
        #region 私有字段
        ...
        /// 设备目录接收
        /// </summary>
        public override event Action<Catalog,string> OnCatalogReceived;
        /// <summary>
        /// 录像文件接收
        /// </summary>
        ...
        public SIPMessageCore_2011()
        {

        }

        public SIPMessageCore_2011(SIPTransport transport, string userAgent)
        {
            //Transport = transport;
        ...
        public override void DeviceCatalogQuery()
        {
            ...
            SIPRequest catalogReq = QueryItems(RemoteEndPoint, RemoteSIPId);
